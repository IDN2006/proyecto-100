...
function draw() {
  if(gameState==="start"){
     ...
     textSize(25);
  stroke("red");
  text("Presiona enter para comenzar",0,200);
 if (keyDown("ENTER")) {
  ball.velocityX = 3;
  ball.velocityY = 4;
 gameState="play";
